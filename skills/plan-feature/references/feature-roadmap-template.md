...
<!-- Phase: "Planning" = still being defined by /plan-feature, not ready for implementation. "Ready" = planning complete, available for /implement-feature. -->

## Platform & Tools Summary

_Brief summary of the platform, language, and key tools from the Feature Definition._
