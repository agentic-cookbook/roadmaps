...
## CG-9.1. Platform Design Languages
...
See CG-1.12 for accessibility requirements (contrast, labels, focus order).
...
- See CG-1.12 for Dynamic Type / font scaling requirements
...
- **Contrast minimums** (WCAG AA, per CG-1.12):
...
1. **Loading** — show progress (see CG-1.5). Use skeleton screens for content-heavy
...
See CG-1.12 for full accessibility requirements.
...
- **Always respect reduced-motion preferences** — see CG-1.15 and each platform
