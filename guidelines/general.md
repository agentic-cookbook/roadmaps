...
## CG-1.1. Prefer native controls and libraries
...
## CG-1.2. For novel components, prefer proven open-source solutions
...
## CG-1.3. Surface all design decisions
...
## CG-1.4. No blocking the main thread
...
## CG-1.6. Comprehensive unit testing
...
## CG-1.8. Post-generation verification
...
3. **Lint**: Run the platform linter (see CG-1.21)
...
## CG-1.11. Scriptable and automatable
...
## CG-1.12. Accessibility from day one
...
## CG-1.15. Respect accessibility display options
...
## CG-1.16. Privacy and security by default

### CG-1.16.1. Data minimization
